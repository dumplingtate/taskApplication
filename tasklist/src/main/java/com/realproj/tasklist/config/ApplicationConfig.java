...
import com.realproj.tasklist.web.security.expression.CustomSecurityExceptionHandler;
...
@Configuration
@EnableWebSecurity
//@EnableMethodSecurity //мешает реализации customSecurityException...
                ...
                .exceptionHandling(configurer ->
                        configurer.authenticationEntryPoint(
                                        (request, response, exception) -> {
                                            ...
                                            response.getWriter()
                                                    .write("Unauthorized. " + exception.getMessage());
                                        })
                                .accessDeniedHandler(
                                        (request, response, exception) -> {
                                            response.setStatus(
